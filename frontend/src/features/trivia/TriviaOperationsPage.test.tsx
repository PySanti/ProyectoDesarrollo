...
describe("TriviaOperationsPage", () => {
  ...
  it("creates a Trivia form with one complete question", async () => {
    ...
    await userEvent.type(screen.getByLabelText(/^pregunta/i), "Pregunta demo");
    await userEvent.type(screen.getByLabelText(/opcion a/i), "A");
    await userEvent.type(screen.getByLabelText(/opcion b/i), "B");
    await userEvent.type(screen.getByLabelText(/opcion c/i), "C");
    await userEvent.type(screen.getByLabelText(/opcion d/i), "D");
