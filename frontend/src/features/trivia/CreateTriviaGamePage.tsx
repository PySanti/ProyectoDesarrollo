...
export function CreateTriviaGamePage({ accessToken }: CreateTriviaGamePageProps) {
  ...
  const noCompleteForms = !formsLoading && !formsError && forms.length === 0;
      ...
      <div className="card stack">
        <header className="create-head">
          <div>
            ...
            <p className="muted">
              Publica una partida a partir de un formulario completo y define su modalidad y límites.
            </p>
          </div>
        </header>
        ...
        {noCompleteForms ? (
          <div className="notice info">
            Aún no tienes formularios completos. Crea uno en la pestaña <strong>Crear formulario</strong>{" "}
            antes de configurar una partida.
          </div>
        ) : null}
