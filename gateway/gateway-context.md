...
Las sub-rutas `/identity/users` y `/identity/teams` ganan sobre `/identity/{**catch-all}` por
`Order` explícito (1 < 2). El coarse-role del gateway autoriza por rol base; la autorización por
