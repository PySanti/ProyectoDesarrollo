...
public sealed class GetTriviaGameParticipantsQueryHandler
    : IRequestHandler<GetTriviaGameParticipantsQuery, TriviaGameLobbyDto>
{
    ...
    public GetTriviaGameParticipantsQueryHandler(
    ...
    public async Task<TriviaGameLobbyDto> Handle(
        GetTriviaGameParticipantsQuery request,
