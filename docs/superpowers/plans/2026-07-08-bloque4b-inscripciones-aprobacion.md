...
- [x] **Step 1: Reescribir los tests de dominio de `InscripcionPartida`**
...
- [x] **Step 3: Anexar valores al enum**
...
- [x] **Step 4: Implementar el ciclo de vida en `InscripcionPartida`**
...
- [x] **Step 5: Correr los tests hasta verde**
...
- [x] **Step 1: Escribir los tests de aprobación del agregado**
...
- [x] **Step 2: Correr para ver fallo de compilación**
...
- [x] **Step 3: Crear la excepción `InscripcionNoPendienteException`**
...
- [x] **Step 4: Modificar `SesionPartida`**
...
- [x] **Step 5: Correr los tests de aprobación hasta verde**

Run: `dotnet test services/operaciones-sesion/tests/Umbral.OperacionesSesion.UnitTests/Umbral.OperacionesSesion.UnitTests.csproj --filter "FullyQualifiedName~SesionPartidaAprobacionTests"`
Expected: PASS.

- [x] **Step 6: Arreglar tests de regresión que asumían nacer `Activa`**
...
- [x] **Step 1: Escribir test de persistencia (round-trip del snapshot + estado Pendiente)**
...
- [x] **Step 2: Correr para ver fallo**
...
- [x] **Step 3: Mapear el snapshot como colección primitiva**
...
- [x] **Step 5: Actualizar las queries de participación del repositorio**
...
- [x] **Step 6: Correr integración + regresión del repo hasta verde**
...
- [x] **Step 1: Escribir/extender el test de routing**
...
- [x] **Step 3: Añadir los records de evento**
...
- [x] **Step 4: Añadir los 3 métodos a la interfaz y a los 4 publishers**
...
- [x] **Step 5: Registrar las 3 routing keys**
...
- [x] **Step 6: Extender el `FakeSesionEventsPublisher` de tests**
...
- [x] **Step 7: Compilar y correr routing + suite unit**
...
- [x] **Step 1: Escribir los tests de handler**
...
- [x] **Step 4: Crear el handler de aceptar**
...
- [x] **Step 5: Crear el handler de rechazar**
...
- [x] **Step 6: Correr los tests de handler hasta verde**
...
- [x] **Step 1: Actualizar el test de preinscripción**
...
- [x] **Step 3: Modificar `PreinscribirEquipoCommandHandler`**
...
- [x] **Step 4: Añadir emisión de `InscripcionSolicitada` en el flujo individual**
...
- [x] **Step 5: Actualizar/crear el test del handler individual**
...
- [x] **Step 6: Verificar el registro DI del handler individual**
...
- [x] **Step 7: Correr suite unit completa hasta verde**
...
- [x] **Step 1: Escribir el test de lobby con pendientes**
...
- [x] **Step 4: Actualizar `MapearLobby`**
...
- [x] **Step 5: `mi-sesion` con `OcupaParticipacion`**
...
- [x] **Step 6: Test de `mi-sesion` en estado Pendiente**
...
- [x] **Step 7: Correr suite unit hasta verde**
...
- [x] **Step 1: Escribir los tests de controlador**
...
- [x] **Step 3: Añadir los endpoints al controller**
...
- [x] **Step 4: Mapear la nueva excepción a 409**
...
- [x] **Step 5: Correr los tests de controlador hasta verde**

Run: `dotnet test services/operaciones-sesion/tests/Umbral.OperacionesSesion.UnitTests/Umbral.OperacionesSesion.UnitTests.csproj --filter "FullyQualifiedName~SesionesControllerAprobacionTests"`
Expected: PASS.

- [x] **Step 6: Correr la solución completa**
...
- [x] **Step 1: Registrar los 3 eventos en el contrato de eventos**
...
- [x] **Step 2: Documentar los endpoints y el `LobbyDto` en el contrato HTTP**
...
- [x] **Step 3: Verificar/añadir contract tests de forma de evento**
...
- [x] **Step 4: Actualizar la matriz de trazabilidad**
