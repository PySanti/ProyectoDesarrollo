...
| HU-22 | Ver participantes unidos a Trivia publicada | First sprint | Trivia Game Service | TBD by SDD | React web | `contracts/http/trivia-game-api.md` (GET `/api/trivia-games/{id}/participants`) | SDD needs update — backend implemented (3 app tests + 1 API test added, 325/326 total) |
| HU-23 | Ver equipos unidos a Trivia publicada | First sprint | Trivia Game Service | TBD by SDD | React web | `contracts/http/trivia-game-api.md` (GET `/api/trivia-games/{id}/teams`) | SDD needs update — backend implemented (3 app tests + 1 API test added, 325/326 total) |
| HU-24 | Iniciar manualmente Trivia | First sprint | Trivia Game Service | Identity Service (JWT / Operador role) | React web | `contracts/http/trivia-game-api.md` (POST `/api/trivia-games/{id}/start`) | Backend done — 2 handler + 2 API tests (325/326 total) |
