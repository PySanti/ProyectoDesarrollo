...
For HU-06 specifically, no cross-service integration event publication is required for closure. Leadership transfer is handled as an internal Team Service state change; `LiderazgoTransferido` may be recorded by Team Service history mechanisms when implemented.
